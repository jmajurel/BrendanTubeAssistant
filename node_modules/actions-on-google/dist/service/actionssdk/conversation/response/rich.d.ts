...
/** @public */
export declare type RichResponseItem = string | SimpleResponse | BasicCard | BrowseCarousel | MediaResponse | OrderUpdate | LinkOutSuggestion | Api.GoogleActionsV2RichResponseItem;
/** @public */
